...
from schemas_new import (
    ...
    DocumentPaperRequest, DocumentPaperResponse
)
from openai_service import generate_paper_with_ai, evaluate_paper_with_ai, generate_paper_from_document
